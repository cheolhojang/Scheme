...
(((lambda (x y) (lambda (z) (+ z y x))) 2 3) 1)
; expect 6
...
(let ((a (lambda (x y) (* x y))) (b 2) (c 3)) (a b c))
; expect 6

(define f (mu (x) (+ x y 2)))
; expect f

(define g (lambda (x y) (f (* x y 2))))
; expect g

(g 1 3)
; expect 11

;; BELOW ARE SOME TEST CASES FROM HW AND LAB IN SCHEME
(define (cddr s)
  (cdr (cdr s)))
; expect cddr
...
(filter (lambda (x) (= (modulo x 2) 1)) (list 1 2 3 4 5 6 7))
; expect (1 3 5 7)
